...
programs = {
    "V JISONI":
        {
            "url": "https://github.com/nedpals/jisoni",
            "commands":[os.path.join(PARSERS_DIR, "test_v_jisoni/jisoni")]
        },
   ...
   "Go 1.7.1":
       {
           "url":"",
           "commands":[os.path.join(PARSERS_DIR, "test_go/test_json.exe")]
       },
   ...
   "JavaScript":
       {
           "url":"",
           "commands":["C:\\Program Files\\nodejs\\node.exe", os.path.join(PARSERS_DIR, "test_json.js")]
       },
   "Python 2.7.10":
       {
           "url":"",
